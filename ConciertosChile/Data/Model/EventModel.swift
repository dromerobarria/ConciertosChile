...
final class EventModel {
    ...
    init(id: UUID = UUID(),name: String,date: String,title: String,month: String ,url: String,web: String, favorite: Bool = false, time: Date? = nil) {
        self.id = id
        self.name = name
        self.date = date
        self.title = title
